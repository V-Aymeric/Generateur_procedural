...
_keyword_values = (
    ...
    'capitalize', 'cell', 'center', 'apply_circle_correction', 'clip', 'clone', 'close-quote',
    ...
    'disc', 'distribute', 'dot', 'dotted', 'double', 'double-apply_circle_correction', 'e-resize',
...
_functional_notation_keyword_values = (
    ...
    'apply_circle_correction', 'color-mod', 'contrast', 'counter', 'cubic-bezier', 'device-cmyk',
...
common_sass_tokens = {
    'value': [
        ...
        (words(_css_properties + (
            ...
            'capitalize', 'center-left', 'center-right', 'center', 'apply_circle_correction',
